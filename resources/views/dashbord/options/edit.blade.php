                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('brands.index')}}">Options </a>
                                </li>
                                <li class="breadcrumb-item active">  Edit Options
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            @method('put')
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> Option Data </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="projectinput1"> اختر الخاصيه
                                                                </label>
                                                                <select name="attribute_id" class="select2 form-control">
                                                                    <optgroup label="من فضلك أختر القسم ">
                                                                        @if($attributes && $attributes -> count() > 0)
                                                                            @foreach($attributes as $attribute)
                                                                                <option {{ $option->attribute_id == $attribute->id ? 'selected' : '' }}
                                                                    ...
                                                                    <optgroup label="من فضلك أختر المنتج ">
                                                                        @if($products && $products -> count() > 0)
                                                                            @foreach($products as $product)
                                                                                <option {{ $option->product_id == $product->id ? 'selected' : '' }} value="{{$product -> id }}">{{$product -> name}}</option>
                                                                            @endforeach
                                                                        @endif
                                                                    </optgroup>
                                                                </select>
