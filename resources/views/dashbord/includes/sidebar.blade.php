        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('product.general.create')}}" data-i18n="nav.dash.crypto">أضافة
                        منتج جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('attribute.create')}}" data-i18n="nav.dash.crypto">أضافة
                         جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                <a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">قيم المنتجات   </span>
                    <span
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{route('option.create')}}" data-i18n="nav.dash.crypto">أضافة
                         جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">وسائل التوصيل</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('edit.shpping.method','free')}}"
                                   data-i18n="nav.templates.vert.classic_menu">توصيل مجانى</a>
                            </li>
                            <li><a class="menu-item" href="{{route('edit.shpping.method','inner')}}">توصيل داخلى</a>
                            </li>
